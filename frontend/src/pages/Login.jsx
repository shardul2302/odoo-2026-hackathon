...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success("Opening EcoSphere admin panel");
        ...
        <div className="w-full max-w-md space-y-8">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Use one of the built-in demo accounts below to test the dashboard.
            </p>
          </div>
          ...
          <div className="rounded-lg border border-border/70 bg-muted/30 p-4 text-sm">
            ...
            <ul className="mt-2 space-y-1 text-muted-foreground">
              <li><span className="font-medium text-foreground">Admin:</span> admin@ecosphere.com / Admin123!</li>
              <li><span className="font-medium text-foreground">Employee:</span> employee@ecosphere.com / Employee123!</li>
              <li><span className="font-medium text-foreground">Manager:</span> manager@ecosphere.com / Manager123!</li>
            </ul>
          </div>
